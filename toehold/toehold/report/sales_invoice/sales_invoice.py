...
def get_columns():
    columns = [
        ...
        _("Sales Taxes and Charges Template") + ":Link/Sales Taxes and Charges Template:200",
...
def get_data(filters):
    ...
    data_query = """
        SELECT si.posting_date, si.customer, si_item.item_code, si_item.qty, si_item.amount,si_item.description,
               si.taxes_and_charges, si.total_taxes_and_charges, si.grand_total,si.custom_category,si.custom_customer_email,
               si.custom_place_of_supply AS place_of_supply, item.custom_hsn_sac AS hsn_sac
    ...
    for invoice in sales_invoices:
        row = [
            ...
            invoice.customer,
            invoice.custom_customer_email,
            invoice.custom_category,
            invoice.item_code,
            invoice.description,
